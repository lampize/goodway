...
<html>
    ...
    <div class="content">
        ...
        <div class="form-group" >
            <label class="col-md-3 label">Author</label>
            <div class="col-md-6">
        ...
        <div class="form-group" >
            <label class="col-md-3 label">Price</label>
            <div class="col-md-6">
        ...
        <div class="form-group" >
            <label class="col-md-3 label">Sale Price</label>
            <div class="col-md-6">
        ...
        <div class="form-group" >
            <label class="col-md-3 label">Image </label>
            <div class="col-md-6">
